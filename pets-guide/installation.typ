...
The data processing procedure consists of two main steps, data reduction and structure solution and refinement. The tools used in the procedure are listed in #ref(<tab:tools>).
...
Make sure that it is available from any location by running `crysm --help`. You should get a message showing how to use `crysm` and listing all available commands.
...
Similarly it is possible to get instructions for how to use subcommands by running `crysm COMMAND --help`
